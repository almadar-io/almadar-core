 ...
 * factories generated by the std-ts codegen. The script bakes the same overlay
 * logic into each emitted factory; the runtime form lifts it out so
 * team-published behaviors (Firestore-stored, not code-published) can flow
