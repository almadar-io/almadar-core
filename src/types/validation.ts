...
export const KNOWN_VALIDATION_ERROR_CODES = {
  ...
  ORB_BINDING_DISPATCH_ROOT_IN_TICK: 'ORB_BINDING_DISPATCH_ROOT_IN_TICK',
  ORB_BINDING_ROOT_NO_PATH: 'ORB_BINDING_ROOT_NO_PATH',
  ORB_BINDING_EVENT_INVALID_PATH: 'ORB_BINDING_EVENT_INVALID_PATH',
  ...
  // Entity / field
  ORB_E_DEFAULT_TYPE_MISMATCH: 'ORB_E_DEFAULT_TYPE_MISMATCH',
